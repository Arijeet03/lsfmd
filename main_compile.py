...
def open_passport_selection():
    ...
    subprocess.run(["python", os.path.join(base_dir, "passport_selection.py")])
...
def open_employee_profiles():
    ...
    base_dir = os.path.dirname(os.path.abspath(__file__))
    image_path = os.path.join(base_dir, "sources", "eGweu7I.png")
...
def open_reply_to_profile():
    base_dir = os.path.dirname(os.path.abspath(__file__))
    subprocess.run(["python", os.path.join(base_dir, "reply_to_profile.py")])

# Function to open the resignations window
def open_resignations():
    base_dir = os.path.dirname(os.path.abspath(__file__))
    subprocess.run(["python", os.path.join(base_dir, "resignations.py")])
